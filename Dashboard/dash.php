...
<body>
    ...
    <div class="dashboard-container" >
        ...
        <div class="content fixed-top d-flex" >
            ...
            <form style="background-color:yellow; height: 50px" action="../projets/collaboration.php" method="POST" class="d-flex gap-3 mt-4 g-3">
                <div>
                    <?php
                        //if ($messa)
                    ?>
            ...
            <div class="projets">
                ...
                <?php
                    ...
                    if($projets ) {
                       ...
                       echo ("<h1 class='titre' >Vous avez créé $n Projets</h1>");
